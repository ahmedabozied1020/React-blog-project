...
const Home = () => {
  const { posts, error, loading } = UseGetPost();
  ...
  return (
    <div className="m-10 rounded-2xl">
      ...
      <div className="flex flex-wrap w-4/5 mx-auto justify-between mt-10">
        {posts.map((post) => (
          <div key={post.id} className="border rounded-md w-[32%] mb-8">
            ...
            <h2 className="text-xl font-semibold my-4 px-2">{post.title}</h2>
            <p className="pb-5 px-2 ">{post.body}</p>
            <div className="flex items-center space-x-4 ms-5 mb-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div className="mb-5 flex justify-end me-3">
              <Link
